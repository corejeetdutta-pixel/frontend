const Footer = () => {
  return (
    <footer className="w-full">
      {/* Blue Section */}
      <div className="bg-[#0260a4] text-white py-8 rounded-t-2xl shadow-lg">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            {/* Nav Links */}
            <div className="flex flex-wrap justify-center gap-6 text-sm font-medium mb-6 md:mb-0">
            ...
            <div className="flex space-x-5">
              {/* Facebook */}
              <a href="#" className="hover:text-green-200 transition-transform transform hover:scale-110">
      ...
      <div className="bg-white text-center py-4 border-t border-gray-200">
        <div className="flex justify-center items-center gap-1">
          <p className="text-[28px] font-semibold text-black">A core company |</p>
          <img src="/core-logo.png" alt="CORE Careers Logo" className="h-12 object-contain" />
        </div>
      </div>
    </footer>
  );
