...
const BotModal = ({ job, user, onClose, onFinish, isApplied: initialApplied }) => {
  ...
  const handleSendResume = async () => {
    try {
      ...
      setResumeSent(true);
      setApplied(true);
      if (onFinish) onFinish(job.jobId); // Notify parent component
                    ...
                    <>
                      {!started && !enhancedCv && !paymentCompleted && (
                        <>
                          ...
                          <p className="mb-4">Let's check if you're a good fit for this position.</p>
                          <button
                      ...
                      {step === "results" && !qualified && (
                        <>
                          <div className="py-6">
                            ...
                            <p className="text-gray-600 mb-6">Unfortunately, your qualifications don't meet the requirements for this position.</p>
                      ...
                      {step === "enhancePrompt" && (
                        <>
                          <div className="py-6">
                            ...
                            <p className="mb-4">Your score: {score}/100</p>
                            <p className="text-gray-700 mb-6">Would you like to enhance your resume for this specific position?</p>
                            <div className="flex flex-col gap-3">
                              <button onClick={handlePayAndEnhance} className="bg-indigo-600 text-white px-4 py-2 rounded">
                                Yes, Enhance My Resume (₹299)
                              </button>
                              <button
                                onClick={async () => {
                                  await handleSendResume();
                      ...
                      {step === "enhancedResume" && enhancedCv && (
                        <>
                          <div className="py-6">
                            ...
                            <p className="text-gray-700 mb-6">Your resume has been tailored for this position.</p>
                      ...
                      {(step === "success" || (resumeSent && step !== "enhancedResume")) && (
                        <div className="py-6">
                          ...
                          <h2 className="text-green-700 text-xl font-bold mb-2">Application Submitted!</h2>
                          <p className="text-gray-700 mb-6">Your resume has been sent to the employer.</p>
                          <button
                            onClick={handleCloseOnly}
                            className="bg-gray-600 text-white px-4 py-2 rounded"
                          >
